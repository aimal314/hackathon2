...
const NavBar = () => {
  return (
    <div>
      {/* Navigation */}
      <nav className="hidden md:flex space-x-10  text-center place-items-center items-center justify-center h-[80px] w-[1440px]">
        {/* Hidden on small screens, flex on medium and up */}
        <Link href="/Avion" className="text-black  hover:text-black transition duration-300 text-4xl -ml-6">
          Avion
          </Link>
